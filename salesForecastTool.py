...
# Author:       David Vega
# Date:         9/8/19
# Description:  This purpose of this program is to clean and create usable excel
#               sheets out of data extracted from a pdf file converted using PDF
#               converter. This program is specifically designed for pdf
#               reports generated by company X. This program will not work
#               for other reports without serious modifications. test
################################################################################
...
def copyColumn(sheet, col1, col2):
...
if response == 1:
  ...
  copyColumn(ws, 'A%s', 'U%s')  # copy contents of column A to column U
  ...
  moveOneUp(ws, 'U%s', 'W%s')
  moveTwoUp(ws, 'D%s', 'X%s')
  moveTwoUp(ws, 'E%s', 'Y%s')
  moveTwoUp(ws, 'F%s', 'Z%s')
  moveTwoUp(ws, 'G%s', 'AA%s')
  moveTwoUp(ws, 'I%s', 'AB%s')
  moveTwoUp(ws, 'J%s', 'AC%s')
  moveTwoUp(ws, 'K%s', 'AD%s')
  moveTwoUp(ws, 'L%s', 'AE%s')
  moveTwoUp(ws, 'M%s', 'AF%s')
  moveTwoUp(ws, 'N%s', 'AG%s')
  moveTwoUp(ws, 'O%s', 'AH%s')
  moveTwoUp(ws, 'P%s', 'AI%s')
  moveTwoUp(ws, 'Q%s', 'AJ%s')
  ...
  copyColumn(ws, 'T%s', 'V%s')  # copy column T to column V
...
################################################################################
# Generate report (option2)
################################################################################
if response == 2:
  increase = decInput()  # projected sales increase for current year
  percentInc = str(round(increase * 100)) + '%'  # to show percentage in footer
  ...
  sheetName = 'details'
  df4.to_excel(writer, sheet_name=sheetName)  # print dataframe to excel sheet
